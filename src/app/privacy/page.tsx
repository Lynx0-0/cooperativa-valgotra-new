      ...
      <>
        ...
        <section className="bg-green-700 text-white py-16">
          <div className="container">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-center mt-4">
              Impegno alla protezione dei dati personali di Cooperativa Valgotra
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
              <div className="prose prose-lg max-w-none">
                <p className="lead">
                  La presente Privacy Policy ha lo scopo di descrivere le modalità di gestione del sito Coop. Valgotra in riferimento al trattamento dei dati personali degli utenti che lo consultano.
                </p>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4">Finalità del Trattamento</h2>
                <p>
                  I dati personali forniti dagli utenti che inoltrano richieste di servizi o richiedono informazioni sono utilizzati al solo fine di eseguire il servizio o la prestazione richiesta e sono comunicati a terzi nel solo caso in cui ciò sia a tal fine necessario.
                </p>
                ...
                <p>
                  Il trattamento dei dati viene effettuato attraverso strumenti informatici e/o telematici, con modalità organizzative e con logiche strettamente correlate alle finalità indicate.
                </p>
                <p>
                  I dati sono trattati presso la sede operativa del Titolare ed in ogni altro luogo in cui le parti coinvolte nel trattamento siano localizzate. Per ulteriori informazioni, è possibile contattare il Titolare.
                </p>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4">Modifiche alla Privacy Policy</h2>
                <p>
                  Il Titolare si riserva il diritto di apportare modifiche alla presente Privacy Policy in qualunque momento, dandone pubblicità agli utenti su questa pagina. Si prega dunque di consultare spesso questa pagina, prendendo come riferimento la data di ultima modifica indicata in fondo.
                </p>
